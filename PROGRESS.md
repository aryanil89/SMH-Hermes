...
Last updated: **2026-08-06 — merged `face-cpu-phase-a` (wall-side approval panel with the captured photo, CPU face-vision pipeline) into the dashboard presentation redesign + demo mode**.
